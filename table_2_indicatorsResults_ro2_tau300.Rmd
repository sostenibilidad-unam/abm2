...
A<-data.frame(read.csv(file="concat_teoretical_Nov2017_ro2tau300.csv",header = F,comment.char ="#"))#,colClasses = 
...
write.csv(x = DD,file = "optimalpolicies_weights_ro2tau300.csv")
```

Figure

```{r,fig.align='center',fig.height=5,fig.width=15,echo=TRUE}
...
png(filename = "c:/Users/abaezaca/Dropbox (ASU)/MEGADAPT/abm2/Files_publication_ABM1/Figure4_tradeoffs_ro2tau300.png",width = 12,height = 4,units ="in",res=300) 
grid.arrange(p8,p10,p11,ncol=3)
dev.off()

png(filename = "c:/Users/abaezaca/Dropbox (ASU)/MEGADAPT/abm2/Files_publication_ABM1/Legend_Figure4_tradeoffs_ro2tau300.png",width = 10,height = 10,units ="in",res=300) 
legend_p
dev.off()
