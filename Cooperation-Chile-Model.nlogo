...
to make-rain
  ifelse random-float 1 > temp_corr[
    set Rain ifelse-value (p_good > random-float 1)[2][1]
  ]
  [
    set Rain R_initial
  ]
...
to final-decisions
  ask contracts [
    ask both-ends[
      ...
      let U-Dc rain * productivity * (L + Lc - Lw) + wages * Lw
...
to update-trust-reputation
  ask contracts [
    ask both-ends[
      if [agreement] of other-end = "D" and [Final_action] of other-end = "D"[
        set score 1
      ]
      if [agreement] of other-end = "D" and [Final_action] of other-end = "C"[
        set score 2
      ]
      if [agreement] of other-end = "C" and [Final_action] of other-end = "D"[
        set score 0
      ]
      if [agreement] of other-end = "C" and [Final_action] of other-end = "C"[
        set score 3
      ]
